...
import { filterValidBannerFiles, formatBannerMaxSize } from "@/lib/bannerUpload";
...
function CreateAlbum() {
  ...
  const handleImageUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    const { accepted, errors } = filterValidBannerFiles(Array.from(files));
    ...
    const newBanners: BannerForm[] = accepted.map((file) => ({
      image: file,
    ...
    <div className="container">
      ...
      <div className="mb-4">
        ...
        <small className="text-muted d-block mt-2">
          Maximum file size: {formatBannerMaxSize()} per image.
        </small>
